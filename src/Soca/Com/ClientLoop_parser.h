...
l_1: if ( *data != 'U' ) goto l_0;
     ...
     if ( sipe_data->_mark[ 0 ] ) {
         ...
         sipe_data->_inp_cont = &&cnt_mark_0x8562b90;
...
l_0: if ( *data != 'V' ) goto l_2;
     ...
     if ( sipe_data->_mark[ 0 ] ) {
         ...
         sipe_data->_inp_cont = &&cnt_mark_0x85621f0;
         SIPE_CHARP beg = (SIPE_CHARP)sipe_data->_mark_data[ 0 ].data();
         int res = parse( sipe_data, beg, beg + sipe_data->_mark_data[ 0 ].size() );
         if ( res )
             return res;
...
l_2: if ( *data != 'W' ) goto l_4;
     ...
     if ( sipe_data->_mark[ 0 ] ) {
         ...
         sipe_data->_inp_cont = &&cnt_mark_0x8565a30;
         SIPE_CHARP beg = (SIPE_CHARP)sipe_data->_mark_data[ 0 ].data();
         int res = parse( sipe_data, beg, beg + sipe_data->_mark_data[ 0 ].size() );
         if ( res )
             return res;
...
l_4: if ( *data != 'X' ) goto l_5;
     ...
     if ( sipe_data->_mark[ 0 ] ) {
         ...
         sipe_data->_inp_cont = &&cnt_mark_0x855f078;
         SIPE_CHARP beg = (SIPE_CHARP)sipe_data->_mark_data[ 0 ].data();
         int res = parse( sipe_data, beg, beg + sipe_data->_mark_data[ 0 ].size() );
         if ( res )
             return res;
...
l_5: if ( *data != 'Y' ) goto l_6;
     ...
     if ( sipe_data->_mark[ 0 ] ) {
         ...
         sipe_data->_inp_cont = &&cnt_mark_0x862d860;
         SIPE_CHARP beg = (SIPE_CHARP)sipe_data->_mark_data[ 0 ].data();
         int res = parse( sipe_data, beg, beg + sipe_data->_mark_data[ 0 ].size() );
         if ( res )
             return res;
...
l_6: if ( *data != 'p' ) goto l_7;
     ...
     if ( sipe_data->_mark[ 0 ] ) {
         ...
         sipe_data->_inp_cont = &&cnt_mark_0x8636e68;
         SIPE_CHARP beg = (SIPE_CHARP)sipe_data->_mark_data[ 0 ].data();
         int res = parse( sipe_data, beg, beg + sipe_data->_mark_data[ 0 ].size() );
         if ( res )
             return res;
...
l_7: if ( *data != 'P' ) goto l_8;
     ...
     if ( sipe_data->_mark[ 0 ] ) {
         ...
         sipe_data->_inp_cont = &&cnt_mark_0x8587838;
         SIPE_CHARP beg = (SIPE_CHARP)sipe_data->_mark_data[ 0 ].data();
         int res = parse( sipe_data, beg, beg + sipe_data->_mark_data[ 0 ].size() );
         if ( res )
             return res;
...
l_8: if ( *data != 'R' ) goto l_9;
     ...
     if ( sipe_data->_mark[ 0 ] ) {
         ...
         sipe_data->_inp_cont = &&cnt_mark_0x863ddb0;
         SIPE_CHARP beg = (SIPE_CHARP)sipe_data->_mark_data[ 0 ].data();
         int res = parse( sipe_data, beg, beg + sipe_data->_mark_data[ 0 ].size() );
         if ( res )
             return res;
...
l_9: if ( *data != 'N' ) goto l_10;
     ...
     if ( sipe_data->_mark[ 0 ] ) {
         ...
         sipe_data->_inp_cont = &&cnt_mark_0x86436a8;
         SIPE_CHARP beg = (SIPE_CHARP)sipe_data->_mark_data[ 0 ].data();
         int res = parse( sipe_data, beg, beg + sipe_data->_mark_data[ 0 ].size() );
         if ( res )
             return res;
...
l_10:if ( *data != 'L' ) goto l_11;
     ...
     if ( sipe_data->_mark[ 0 ] ) {
         ...
         sipe_data->_inp_cont = &&cnt_mark_0x86491e8;
         SIPE_CHARP beg = (SIPE_CHARP)sipe_data->_mark_data[ 0 ].data();
         int res = parse( sipe_data, beg, beg + sipe_data->_mark_data[ 0 ].size() );
         if ( res )
             return res;
